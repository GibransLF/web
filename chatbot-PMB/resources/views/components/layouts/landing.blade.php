    ...
    @else
        ...
        <div class="flex-1 w-full">
            <div class="max-w-[1280px] mx-auto flex flex-col lg:flex-row min-h-[calc(100vh-4rem)]">
                ...
                <!-- Right Area: Fixed Chatbot Sidebar (Only visible on desktop outside /chat) -->
                <div id="chatbot-sidebar" class="hidden lg:block w-full lg:w-1/3 lg:sticky lg:top-16 lg:h-[calc(100vh-4rem)] shrink-0">

<x-layouts.landing>
    <div class="space-y-20 pb-20">
        ...
        <section>
            <div
                class="bg-[#1B287D] rounded-3xl p-8 lg:p-16 flex flex-col md:flex-row items-center justify-between text-white overflow-hidden relative">
        ...
        <section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <flux:card
                    ...
                    <flux:heading size="lg" class="mb-3 text-zinc-900 dark:text-white font-semibold text-xl">Smart
                        Campus</flux:heading>
                    <flux:text class="text-zinc-600 dark:text-zinc-400">
                        Mengkombinasikan dan Mengimplementasikan proses belajar dalam lingkungan kampus dengan
                        menggunakan Teknologi Informasi canggih.
                    </flux:text>
                </flux:card>
                ...
                <flux:card
                    ...
                    <flux:heading size="lg" class="mb-3 text-zinc-900 dark:text-white font-semibold text-xl">Biaya
                        Terjangkau</flux:heading>
                    <flux:text class="text-zinc-600 dark:text-zinc-400">
                        Biaya Terjangkau
                ...
                <flux:card
                    ...
                    <flux:heading size="lg" class="mb-3 text-zinc-900 dark:text-white font-semibold text-xl">Jaringan
                        Alumni</flux:heading>
                    <flux:text class="text-zinc-600 dark:text-zinc-400">
        ...
        <section
            class="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 lg:p-12 shadow-sm">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="space-y-4 text-lg text-zinc-600 dark:text-zinc-300">
                        <p>
                            STMIK Bandung merupakan STMIK pertama di Jawa Barat dan pelopor pendidikan tinggi
                            informatika swasta dengan fokus untuk mencetak tenaga profesional dan technopreneur IT.
                        </p>
                    </div>
                </div>
                <div class="relative">
                    <div
                        class="aspect-4/3 rounded-2xl overflow-hidden shadow-lg bg-zinc-200 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700">
                        <img src="{{ asset('images/stmik.jpg') }}" alt="Kampus Utama STMIK Bandung"
